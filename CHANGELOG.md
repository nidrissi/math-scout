...
- Renamed the project and command from `llm-reviewer` to `paper-scout`.
...
[Unreleased]: https://github.com/nidrissi/paper-scout/compare/v0.2.0a2...HEAD
[0.2.0a2]: https://github.com/nidrissi/paper-scout/releases/tag/v0.2.0a2
